...
Application and business rules: booster access request/review, booster access matching, lockout conflict, run/signup state machines, signup eligibility, roster draft/publish, character identity/lifecycle, dashboard composition.
