...
export type StorageHash =
  StorageHashBase<'d79acc109f9c4760100a1e605dd78641f11076780b8850d5d682aad52eca8554'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Character: {
      ...
      readonly lastSyncAttemptAt: CodecTypes['pg/timestamptz-string@1']['output'] | null;
      readonly lastSyncErrorAt: CodecTypes['pg/timestamptz-string@1']['output'] | null;
      readonly lastSyncErrorCode:
        | 'PROFILE_UNAVAILABLE'
        | 'IDENTITY_CONFLICT'
        | 'NAME_CONFLICT'
        | 'RATE_LIMITED'
        ...
        | 'INTERNAL'
        | null;
      readonly syncFailureCount: CodecTypes['pg/int4@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    ...
    readonly RunDiscordPost: {
      ...
      readonly lastRosterPostRevision: CodecTypes['pg/int4@1']['output'] | null;
    ...
    readonly RunRoster: {
      ...
      readonly runChangedSinceAck: CodecTypes['pg/bool@1']['output'];
      readonly postRevision: CodecTypes['pg/int4@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Character: {
      ...
      readonly lastSyncAttemptAt: CodecTypes['pg/timestamptz-string@1']['input'] | null;
      readonly lastSyncErrorAt: CodecTypes['pg/timestamptz-string@1']['input'] | null;
      readonly lastSyncErrorCode:
        | 'PROFILE_UNAVAILABLE'
        | 'IDENTITY_CONFLICT'
        | 'NAME_CONFLICT'
        ...
        | 'INTERNAL'
        | null;
      readonly syncFailureCount: CodecTypes['pg/int4@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly CharacterAvailabilityBlock: {
    ...
    readonly RunDiscordPost: {
      ...
      readonly lastRosterPostRevision: CodecTypes['pg/int4@1']['input'] | null;
    ...
    readonly RunRoster: {
      ...
      readonly runChangedSinceAck: CodecTypes['pg/bool@1']['input'];
      readonly postRevision: CodecTypes['pg/int4@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly RunRosterEntry: {
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly character: {
              columns: {
                ...
                readonly lastSyncAttemptAt: {
                  readonly nativeType: 'timestamptz';
                  readonly codecId: 'pg/timestamptz-string@1';
                  readonly nullable: true;
                };
                readonly lastSyncErrorAt: {
                  readonly nativeType: 'timestamptz';
                  readonly codecId: 'pg/timestamptz-string@1';
                  readonly nullable: true;
                };
            ...
            readonly run_discord_post: {
              columns: {
                ...
                readonly lastRosterPostRevision: {
                  readonly nativeType: 'int4';
                  readonly codecId: 'pg/int4@1';
                  readonly nullable: true;
                };
            ...
            readonly user: {
              ...
              indexes: readonly [
                {
                  readonly name: 'user_single_owner_da579d9c';
                  readonly prefix: 'user_single_owner';
                  readonly columns: readonly ['accountRole'];
                  readonly where: '("accountRole" = \'OWNER\'::text)';
          ...
          readonly valueSet: {
            readonly AccountRole: {
              ...
              readonly values: readonly ['USER', 'RAID_LEAD', 'ADMIN', 'OWNER'];
            };
            readonly AccountStatus: {
              readonly kind: 'valueSet';
            ...
            readonly CharacterSyncErrorCode: {
              readonly kind: 'valueSet';
              readonly values: readonly [
                'PROFILE_UNAVAILABLE',
                'IDENTITY_CONFLICT',
      ...
      readonly public: {
          ...
          readonly Character: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly lastSyncAttemptAt: { readonly column: 'lastSyncAttemptAt' };
                readonly lastSyncErrorAt: { readonly column: 'lastSyncErrorAt' };
                readonly lastSyncErrorCode: { readonly column: 'lastSyncErrorCode' };
                readonly syncFailureCount: { readonly column: 'syncFailureCount' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
          ...
          readonly RunDiscordPost: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly lastRosterPostRevision: { readonly column: 'lastRosterPostRevision' };
          ...
          readonly RunRoster: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly runChangedSinceAck: { readonly column: 'runChangedSinceAck' };
                readonly postRevision: { readonly column: 'postRevision' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
        ...
        readonly enum: {
          ...
          readonly CharacterSyncErrorCode: {
            readonly codecId: 'pg/text@1';
            readonly members: readonly [
              { readonly name: 'PROFILE_UNAVAILABLE'; readonly value: 'PROFILE_UNAVAILABLE' },
              { readonly name: 'IDENTITY_CONFLICT'; readonly value: 'IDENTITY_CONFLICT' },
              { readonly name: 'NAME_CONFLICT'; readonly value: 'NAME_CONFLICT' },
              { readonly name: 'RATE_LIMITED'; readonly value: 'RATE_LIMITED' },
              { readonly name: 'UPSTREAM_UNAVAILABLE'; readonly value: 'UPSTREAM_UNAVAILABLE' },
              { readonly name: 'AUTH_OR_CONFIG'; readonly value: 'AUTH_OR_CONFIG' },
